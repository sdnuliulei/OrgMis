...
namespace Ray.Plat.Common
{
    ...
    public class RandUtil
    {
        ...
        public static string GenerateCodeNum(int codeCount)
        {
            if (rep >= 999999999)
                rep = 0;
        ...
        /// <returns></returns>
        public static string RandomSN(int Length)
        {
            return RandomSN(Length, false);
        }
        ...
        /// <param name="Sleep">是否要在生成前将当前线程阻止以避免重复</param>
        /// <returns></returns>
        public static string RandomSN(int Length, bool Sleep)
        {
            if (Sleep)
                System.Threading.Thread.Sleep(3);
